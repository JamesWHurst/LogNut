...
namespace Hurst.LogNut.OutputPipes
{
    ...
    public class WindowsEventLogOutputPipe : IOutputPipe
    {
        ...
        /// <summary>
        /// Retrieve the configuration-settings from the Windows Registry.
        /// </summary>
        public void ReadSettingsFromRegistry()
        {
            LogNutRegistryService reg = LogNutRegistryService.The;
            bool? isSystemEventLogOutputEnabled = reg.GetIsSystemEventLogOutputEnabled( null, null );
        }
        #endregion
