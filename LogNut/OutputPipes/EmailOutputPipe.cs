...
namespace Hurst.LogNut.OutputPipes
{
    ...
    public class EmailOutputPipe : IOutputPipe
    {
        ...
        /// <summary>
        /// Get or set the LogOutputLevel that a given log-record has to be in order to be sent out via email.
        /// The default is Warn, which means that all levels at or above Warn are sent (provided that IsEmailOutputEnabled is set true).
        /// </summary>
        public LogOutputLevel LowestLevelToSend
        {
        ...
        public override string ToString()
        {
            ...
            if (_lowestLevelToSend != default( LogOutputLevel ))
            {
        ...
        public bool Write( LogSendRequest request )
        {
            ...
            if (IsEnabled && !IsFailing)
            {
                ...
                LogOutputLevel levelAllowed = LowestLevelToSend;
        ...
        /// <summary>
        /// This is the minimum LogOutputLevel that a given log-record has to be in order to get sent out via email.
        /// For example, if this is set to Error, then only Error and Fatal log-records get emailed.
        /// The default is Warn.
        /// </summary>
        private LogOutputLevel _lowestLevelToSend = LogOutputLevel.Warn;
