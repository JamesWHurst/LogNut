...
namespace Hurst.LogNut
{
    ...
    public class TestFacility : IDisposable
    {
        ...
        /// <summary>
        /// Get the number of log-records that have been sent of the given LogOutputLevel,
        ...
        public int GetRecordCount( LogOutputLevel ofWhatLevel )
        {
            if (_recordsSinceLastReset == null)
            {
                return 0;
        ...
        /// <summary>
        /// Return true if any log-records have been transmitted with the given LogOutputLevel
        ...
        /// </summary>
        /// <param name="ofWhatLevel">the LogOutputLevel to check for</param>
        ...
        /// <returns>true if a log-record has been transmitted at the given LogOutputLevel containing the given text</returns>
        public bool HasBeenLogged( LogOutputLevel ofWhatLevel, string messageContentFragment, out LogRecord recordFound, int timeoutPeriodInMilliseconds )
        {
            if (_recordsSinceLastReset != null)
            {
        ...
        /// <summary>
        /// Get whether any of the log-records that have been sent of the given LogOutputLevel,
        /// since the the program-under-test started, or since the last call to ResetTestCount,
        ...
        /// <summary>
        /// Get whether anything has been logged at the given LogOutputLevel.
        /// </summary>
        /// <param name="ofWhatLevel">the LogOutputLevel of the log-records that we want to check</param>
        /// <param name="recordFound">if a log-record is found that matches the given criteria, it is placed in this</param>
        /// <returns>true if any log-records have been sent containing the given text</returns>
        public bool HasAnythingBeenLoggedAtLevel( LogOutputLevel ofWhatLevel, out LogRecord recordFound )
        {
            if (_recordsSinceLastReset != null)
            {
                foreach (var r in _recordsSinceLastReset)
