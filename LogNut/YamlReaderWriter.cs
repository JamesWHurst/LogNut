                ...
                foreach (PropertyInfo propertyInfo in properties)
                {
                    ...
                    else if (propertyType == typeof( Decimal ))
                    {
                        ...
                        if (!isToWriteAllValues)
                        {
                            ...
                            if (Decimal.TryParse( stringDefaultValue, out decimal decimalDefaultValue ))
                            {
                    ...
                    else if (propertyType == typeof( Double ))
                    {
                        ...
                        {
                            string stringDefaultValue = attribute0.Value.ToString();
                            if (Double.TryParse( stringDefaultValue, out double defaultValue ))
                            {
                    ...
                    else if (propertyType == typeof( float ))
                    {
                        ...
                        {
                            string stringDefaultValue = attribute0.Value.ToString();
                            if (float.TryParse( stringDefaultValue, out float defaultValue ))
                            {
