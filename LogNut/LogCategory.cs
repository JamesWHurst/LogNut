...
namespace Hurst.LogNut
{
    ...
    #region constructors
        ...
        //public LogCategory( LogOutputLevel logLevel )
        //{
        //    _name = null;
        ...
        //public LogCategory( LogOutputLevel logLevel, string name, ulong mask )
        //{
        //    _name = null;
        //    _mask = mask;
        //    switch (logLevel)
    ...
    #region EnableAllLevels
        ...
        /// <summary>
        /// This denotes lowest-level LogOutputLevel that is currently enabled JUST FOR THIS CATEGORY.
