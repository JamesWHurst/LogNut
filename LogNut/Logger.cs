...
#endif
using Hurst.BaseLib;
using Hurst.BaseLib.Annotations;
...
namespace Hurst.LogNut
{
    ...
    public class Logger : ISimpleLogger
    {
        ...
        /// </summary>
        /// <param name="level">the LogOutputLevel at which to log this</param>
        ...
        /// </remarks>
        public void Log( LogOutputLevel level, LogCategory cat, string textToLog, bool isToSuppressTraceOutput )
        {
            //CBL I had also created LogString because I needed a way to force LogException to come to that method.
        ...
        /// </summary>
        /// <param name="level">the <see cref="LogOutputLevel"/> at which to log this</param>
        /// <param name="cat">You can organize your logging-output into categories by specifying this LogCategory.</param>
        ...
        public void LogStringFormat( LogOutputLevel level, LogCategory cat, string format, params object[] args )
        {
            if (this.IsEffectivelyEnabledForLevelAndCategory( level, cat ))
            {
                try
        ...
        /// <summary>
        /// Output a log-record containing the given log-message (textToLog), at log-level Info.
        ...
        public void Log( string textToLog )
        {
            ...
            LogOutputLevel level = LogOutputLevel.Info;
        ...
        {
#if TRACE
            Log( LogOutputLevel.Trace, LogCategory.Empty, textToLog, false );
#endif
        }
        ...
        {
#if TRACE
            Log( LogOutputLevel.Trace, cat, textToLog, false );
#endif
        }
        ...
        public void LogTrace( string format, params object[] args )
        {
            ...
            LogStringFormat( LogOutputLevel.Trace, cat, format, args );
            // Log( LogOutputLevel.Trace, LogCategory.Empty, format, args );
#endif
        }
        ...
        {
            LogWithContext( LogOutputLevel.Trace, LogCategory.Empty, textToLog, memberName, sourceFilePath, sourceLineNumber );
        }
        ...
        public void LogTraceWithContext( LogCategory cat,
                                         ...
                                         [CallerLineNumber] int sourceLineNumber = 0 )
        {
            LogWithContext( LogOutputLevel.Trace, cat, textToLog, memberName, sourceFilePath, sourceLineNumber );
        }
#else
        /// <summary>
        ...
        public void LogTraceWithContext( string textToLog )
        {
            ...
            LogWithContext( LogOutputLevel.Trace, LogCategory.Empty, textToLog, methodName, frame1.GetFileName(), frame1.GetFileLineNumber() );
        }
        ...
        public void LogTraceWithContext( LogCategory cat, string textToLog )
        {
            ...
            LogWithContext( LogOutputLevel.Trace, cat, textToLog, methodName, frame1.GetFileName(), frame1.GetFileLineNumber() );
        }
#endif
        ...
        public void LogDebug( string textToLog )
        {
            ...
            {
                Log( LogOutputLevel.Debug, LogCategory.Empty, textToLog, false );
            }
        }
        ...
        public void LogDebug( LogCategory cat, string textToLog )
        {
            if (LogManager.Config.IsLoggingEnabled)
            {
                Log( LogOutputLevel.Debug, cat: cat, textToLog: textToLog, isToSuppressTraceOutput: false );
            }
        }
        ...
        {
            LogStringFormat( LogOutputLevel.Debug, LogCategory.Empty, format, args );
        }
        ...
        {
            LogStringFormat( LogOutputLevel.Debug, cat, format, args );
        }
        ...
        public void LogDebugWithContext( string textToLog,
                                         ...
                                         [CallerLineNumber] int sourceLineNumber = 0 )
        {
            LogWithContext( LogOutputLevel.Debug, LogCategory.Empty, textToLog, memberName, sourceFilePath, sourceLineNumber );
        }
        ...
        public void LogDebugWithContext( LogCategory cat,
                                         ...
                                         [CallerLineNumber] int sourceLineNumber = 0 )
        {
            LogWithContext( LogOutputLevel.Debug, cat, textToLog, memberName, sourceFilePath, sourceLineNumber );
        }
#else
        /// <summary>
        ...
        public void LogDebugWithContext( string textToLog )
        {
            ...
            LogWithContext( LogOutputLevel.Debug, LogCategory.Empty, textToLog, methodName, frame1.GetFileName(), frame1.GetFileLineNumber() );
        }
        ...
        public void LogDebugWithContext( LogCategory cat, string textToLog )
        {
            ...
            LogWithContext( LogOutputLevel.Debug, cat, textToLog, methodName, frame1.GetFileName(), frame1.GetFileLineNumber() );
        }
#endif
        ...
        /// <summary>
        /// Log a message at level <c>Info</c>, calling the <c>ToString</c> method of the given object to produce the message.
        /// </summary>
        /// <param name="textToLog">the string that represents the Message to log</param>
        public void LogInfo( string textToLog )
        {
            Log( LogOutputLevel.Info, LogCategory.Empty, textToLog, false );
        }
        ...
        {
            Log( level: LogOutputLevel.Info, cat: cat, textToLog: textToLog, isToSuppressTraceOutput: false );
        }
        ...
        {
            LogStringFormat( LogOutputLevel.Info, LogCategory.Empty, format, args );
        }
        ...
        {
            LogStringFormat( LogOutputLevel.Info, cat, format, args );
        }

#if !PRE_5
        /// <summary>
        /// Log a message at level <c>Info</c>, and add source-code trace information (.Net 4.5+ only).
        /// You would only provide a value for the objectMessage parameter --
        /// let the compiler provide the arguments to the memberName, sourceFilePath, and sourceLineNumber parameters.
        /// </summary>
        /// <param name="textToLog">the string that represents the message to log</param>
        ...
        public void LogInfoWithContext( string textToLog,
                                        ...
                                        [CallerLineNumber] int sourceLineNumber = 0 )
        {
            LogWithContext( LogOutputLevel.Info, LogCategory.Empty, textToLog, memberName, sourceFilePath, sourceLineNumber );
        }
        ...
        public void LogInfoWithContext( LogCategory cat,
                                        ...
                                        [CallerLineNumber] int sourceLineNumber = 0 )
        {
            LogWithContext( LogOutputLevel.Info, cat, textToLog, memberName, sourceFilePath, sourceLineNumber );
        }
#else
        /// <summary>
        ...
        public void LogInfoWithContext( string textToLog )
        {
            ...
            LogWithContext( LogOutputLevel.Info, LogCategory.Empty, textToLog, methodName, frame1.GetFileName(), frame1.GetFileLineNumber() );
        }
        ...
        public void LogInfoWithContext( LogCategory cat, string textToLog )
        {
            ...
            LogWithContext( LogOutputLevel.Info, cat, textToLog, methodName, frame1.GetFileName(), frame1.GetFileLineNumber() );
        }
#endif
        ...
        /// <summary>
        /// Log a message at level <c>Warn</c>, calling the <c>ToString</c> method of the given object to produce the message.
        /// </summary>
        ...
        {
            Log( LogOutputLevel.Warn, LogCategory.Empty, textToLog, false );
        }
        ...
        {
            Log( LogOutputLevel.Warn, cat, textToLog, false );
        }
        ...
        {
            LogStringFormat( LogOutputLevel.Warn, LogCategory.Empty, format, args );
        }
        ...
        {
            LogStringFormat( LogOutputLevel.Warn, cat, format, args );
        }
...
#if !PRE_5
        /// <summary>
        /// Log a message at level <c>Warn</c>, and add source-code trace information (.Net 4.5 and up only).
        /// You would only provide a value for the objectMessage parameter --
        /// let the compiler provide the arguments to the memberName, sourceFilePath, and sourceLineNumber parameters.
        /// </summary>
        /// <param name="textToLog">the string that represents the message to log</param>
        ...
        public void LogWarningWithContext( string textToLog,
                                           ...
                                           [CallerLineNumber] int sourceLineNumber = 0 )
        {
            LogWithContext( LogOutputLevel.Warn, LogCategory.Empty, textToLog, memberName, sourceFilePath, sourceLineNumber );
        }
        ...
        public void LogWarningWithContext( LogCategory cat,
                                           ...
                                           [CallerLineNumber] int sourceLineNumber = 0 )
        {
            LogWithContext( LogOutputLevel.Warn, cat, textToLog, memberName, sourceFilePath, sourceLineNumber );
        }
#else
        /// <summary>
        ...
        public void LogWarningWithContext( string textToLog )
        {
            ...
            LogWithContext( LogOutputLevel.Warn, LogCategory.Empty, textToLog, methodName, frame1.GetFileName(), frame1.GetFileLineNumber() );
        }
        ...
        public void LogWarningWithContext( LogCategory cat, string textToLog )
        {
            ...
            LogWithContext( LogOutputLevel.Warn, cat, textToLog, methodName, frame1.GetFileName(), frame1.GetFileLineNumber() );
        }
#endif
        ...
        {
            Log( LogOutputLevel.Error, LogCategory.Empty, textToLog, false );
        }
        ...
        {
            Log( LogOutputLevel.Error, cat, textToLog, false );
        }
        ...
        {
            LogStringFormat( LogOutputLevel.Error, LogCategory.Empty, format, args );
        }
        ...
        {
            LogStringFormat( LogOutputLevel.Error, cat, format, args );
        }
        ...
        public void LogErrorWithContext( string textToLog,
                                         ...
                                         [CallerLineNumber] int sourceLineNumber = 0 )
        {
            LogWithContext( LogOutputLevel.Error, LogCategory.Empty, textToLog, memberName, sourceFilePath, sourceLineNumber );
        }
        ...
        public void LogErrorWithContext( LogCategory cat,
                                         ...
                                         [CallerLineNumber] int sourceLineNumber = 0 )
        {
            LogWithContext( LogOutputLevel.Error, cat, textToLog, memberName, sourceFilePath, sourceLineNumber );
        }
#else
        /// <summary>
        ...
        public void LogErrorWithContext( string textToLog )
        {
            ...
            LogWithContext( LogOutputLevel.Error, LogCategory.Empty, textToLog, methodName, frame1.GetFileName(), frame1.GetFileLineNumber() );
        }
        ...
        public void LogErrorWithContext( LogCategory cat, string textToLog )
        {
            ...
            LogWithContext( LogOutputLevel.Error, cat, textToLog, methodName, frame1.GetFileName(), frame1.GetFileLineNumber() );
        }
#endif
        #endregion LogError, LogErrorWithContext

        #region LogFatal, LogFatalWithContext
        /// <summary>
        /// Log a message at level <c>Fatal</c>, calling the <c>ToString</c> method of the given object to produce the message.
        /// </summary>
        /// <param name="textToLog">the string that represents the message to log</param>
        public void LogFatal( string textToLog )
        {
            Log( LogOutputLevel.Fatal, LogCategory.Empty, textToLog, false );
        }
        ...
        /// <param name="cat">You can organize your logging-output into categories by specifying this LogCategory.</param>
        /// <param name="textToLog">the string that represents the message to log</param>
        public void LogFatal( LogCategory cat, string textToLog )
        {
            Log( LogOutputLevel.Fatal, cat, textToLog, false );
        }

        /// <summary>
        /// Log a message at level <c>Fatal</c>, the message being the given object-array and expressed using the given string format.
        /// </summary>
        /// <param name="format">the format to use to express the message (as in String.Format)</param>
        /// <param name="args">an array of objects that represents the values to go into the message we want to log</param>
        /// <remarks>
        ...
        {
            LogStringFormat( LogOutputLevel.Fatal, LogCategory.Empty, format, args );
        }
        ...
        /// </remarks>
        [StringFormatMethod( "format" )]
        public void LogFatal( LogCategory cat, string format, params object[] args )
        {
            LogStringFormat( LogOutputLevel.Fatal, cat, format, args );
        }

#if !PRE_5
        /// <summary>
        /// Log a message at level <c>Fatal</c>, and add source-code trace information (.Net 4.5 and higher).
        /// You would only provide a value for the objectMessage parameter --
        /// let the compiler provide the arguments to the memberName, sourceFilePath, and sourceLineNumber parameters.
        /// </summary>
        /// <param name="cat">You can organize your logging-output into categories by specifying this LogCategory.</param>
        ...
        /// This logs the given text-message and also the file, class-member, and line-number at which this call is made.
        /// <code>
        /// LogFatalWithContext("A quite fatal thing has just happened!");
        /// </code>
        /// You only provide the value for objectMessage; the compiler inserts all of the other values.
        /// In this way, you automatically get information written to the log that identifies exactly where this was called.
        /// </example>
        public void LogFatalWithContext( LogCategory cat,
                                         string textToLog,
                                         [CallerMemberName] string memberName = "",
                                         [CallerFilePath] string sourceFilePath = "",
                                         [CallerLineNumber] int sourceLineNumber = 0 )
        {
            LogWithContext( LogOutputLevel.Fatal, cat, textToLog, memberName, sourceFilePath, sourceLineNumber );
        }
#else
        /// <summary>
        /// Log a message at level <c>Fatal</c>, and add source-code trace information including the calling method, source-file path and line-number.
        /// </summary>
        /// <param name="textToLog">the string that represents the message to log</param>
        public void LogFatalWithContext( string textToLog )
        {
            var stackTrace = new StackTrace(fNeedFileInfo: true);
            var frame1 = stackTrace.GetFrame(1);
            string methodName = frame1.GetMethod().Name;

            LogWithContext( LogOutputLevel.Fatal, LogCategory.Empty, textToLog, methodName, frame1.GetFileName(), frame1.GetFileLineNumber() );
        }
        ...
        /// <param name="cat">You can organize your logging-output into categories by specifying this LogCategory.</param>
        /// <param name="textToLog">the string that represents the message to log</param>
        public void LogFatalWithContext( LogCategory cat, string textToLog )
        {
            var stackTrace = new StackTrace(fNeedFileInfo: true);
            var frame1 = stackTrace.GetFrame(1);
            string methodName = frame1.GetMethod().Name;

            LogWithContext( LogOutputLevel.Fatal, cat, textToLog, methodName, frame1.GetFileName(), frame1.GetFileLineNumber() );
        }
#endif
        #endregion
                                  ...
                                  [CallerLineNumber] int sourceLineNumber = 0 )
        {
            ...
            string message = StringLib.ExceptionDetails( x: exception,
            ...
            Log( LogOutputLevel.Error, LogCategory.CatExceptions, message, false );
        ...
        public void LogException( Exception exception )
        {
            ...
            Log( level: LogOutputLevel.Error, cat: LogCategory.CatExceptions, textToLog: message, isToSuppressTraceOutput: false );
        ...
        public void LogException( Exception exception, string format, params object[] args )
        {
            ...
            bool includeNewlines = !LogManager.Config.IsFileOutputSpreadsheetCompatible;
            LogStringFormat( LogOutputLevel.Error,
                             LogCategory.CatExceptions,
                             StringLib.ExceptionDetails( exception,
                                                         includeNewlines,
                                                         additionalInfor,
                                                         null,
                                                         null,
                                                         0,
                                                         LogManager.Config.IsToShowStackTraceForExceptions ) );
            LogManager.ThrowExceptionWasLogged( logger: this, exception: exception, additionalInformation: additionalInfor );
        }
        ...
        public void AddToPresentationTraceListeners( LogOutputLevel levelToLogAt )
        {
        ...
        /// <summary>
        /// Send an (Info-level) log output that simply indicates how much time has elapsed since the last call to SetTimeReference.
        /// </summary>
        /// <param name="cat">You can organize your logging-output into categories by specifying this LogCategory.</param>
        ...
        {
            _lowestLevelThatIsEnabled_override = default( LogOutputLevel );
            return this;
        }
        #endregion
        ...
        /// </remarks>
        public Logger EnableLevelsDownTo( LogOutputLevel level )
        {
        ...
        /// </remarks>
        public LogOutputLevel? LowestLevelThatIsEnabled_Override
        {
        ...
        /// <summary>
        /// Return true if output is enabled for this logger AND according to LogManager, and for this given LogOutputLevel
        /// </summary>
        /// <param name="level">The LogOutputLevel to check for</param>
        /// <returns>true only if this logger is enabled and also enabled for the given LogOutputLevel</returns>
        public bool IsEffectivelyEnabledForLevel( LogOutputLevel level )
        {
        ...
        /// <summary>
        /// Return true if output is enabled for this logger, for this LogOutputLevel, and this LogCategory.
        /// Category overrides level, such that if not enabled by level but is by category - it gets logged.
        /// </summary>
        /// <param name="level"></param>
        /// <param name="cat"></param>
        /// <returns></returns>
        public bool IsEffectivelyEnabledForLevelAndCategory( LogOutputLevel level, LogCategory cat )
        {
            if (cat == null)
            {
        ...
        /// <summary>
        /// Write a log at the Info level that summarizes some statistics regarding the preceding
        ...
        {
            var record = CreateLogRecord(LogOutputLevel.Info, LogCategory.Empty, logMessage);
        ...
        #region AddMeToRegistry
        /// <summary>
        /// Add a key representing this Logger instance to the Windows Registry, within the LogNut area,
        /// so that attributes of this logger may be saved there.
        /// </summary>
        private void AddMeToRegistry()
        {
            //CBL Do I want to use the type LogManager here ?!
            LogNutRegistryService.The.AddLogger( this, LogManager.Config.GetSubjectProgramName( typeof( LogManager ) ), LogManager.Config.SourceHostName );
        }
        #endregion
#endif
        ...
        /// </summary>
        /// <param name="level">The LogOutputLevel associated with this log-record</param>
        ...
        internal LogRecord CreateLogRecord( LogOutputLevel level, LogCategory cat, string theMessageToLog )
        {
        ...
        /// </summary>
        /// <param name="level">the LogOutputLevel to log to</param>
        /// <param name="cat">You can organize your logging-output into categories by specifying this LogCategory.</param>
        ...
        /// </remarks>
        private Logger LogWithContext( LogOutputLevel level, LogCategory cat, object messageObject, string memberName, string sourceFilePath, int sourceLineNumber )
        {
            if (this.IsEffectivelyEnabledForLevelAndCategory( level, cat ))
            {
        ...
        /// <summary>
        /// This denotes lowest-level LogOutputLevel that is currently enabled JUST FOR THIS SPECIFIC LOGGER.
        /// The default is null, which means this logger voices no preference and the LogManager.Config
        /// is what controls.
        /// </summary>
        private LogOutputLevel? _lowestLevelThatIsEnabled_override;
