...
namespace Hurst.LogNut
{
    ...
    public class LogRecord
    {
        ...
        /// <param name="level">The LogOutputLevel assigned to this record</param>
        ...
        #region Level
        /// <summary>
        /// Get or set the LogOutputLevel that is assigned to this log record.
        /// </summary>
        [DataMember]
        [XmlAttribute( "Level" )]
        public LogOutputLevel Level { get; set; }
        #endregion
        ...
        /// 2011-4-15 23:51:10.123[Host / Subjectprogram:1.0.3, Username | 7; Logger1 \ Info {Cat} *v]
        ///
        ...
        public static LogRecord FromText( string text, out string reason )
        {
            ...
            int threadId;
            LogOutputLevel level = default( LogOutputLevel );
            string catName = null;
            ...
            if (indexOfLeftBracket >= 0 && indexOfRightBracket > indexOfLeftBracket)
            {
                ...
                if (indexOfCatStartDelimiter >= 0)
                {
                    ...
                    if (indexOfCatEndDelimiter > indexOfCatStartDelimiter)
                    {
                        ...
                        {
                            if (!NutUtil.TryParseToLogOutputLevel( levelText, out level ))
                            {
                                reason = "invalid LogOutputLevel";
                                return null;
                            }
                        }
                    }
        ...
        /// </summary>
        /// <param name="levelInQuestion">the given LogOutputLevel to match this log-record against</param>
        /// <returns>true if this log-record is at the given level or higher</returns>
        /// <remarks>
        /// The ordering of levels is indicated by it's integer value and is in this order: Info, Debug, Warn, Error, Fatal.
        /// </remarks>
        public bool IsAtLeastOfLevel( LogOutputLevel levelInQuestion )
        {
